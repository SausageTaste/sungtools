...
namespace {
    ...
    int test_distance_conversions() {
        ...
        static_assert(sung::are_similiar_constexpr(distance_m.feet(), distance_ft.feet(), 0.001f), "Distance conversion failed");
        static_assert(sung::are_similiar_constexpr(distance_m.miles(), distance_miles.miles(), 0.001f), "Distance conversion failed");
        static_assert(sung::are_similiar_constexpr(distance_m.nautical_miles(), distance_nautical_miles.nautical_miles(), 0.001f), "Distance conversion failed");
    ...
    int test_speed_conversions() {
        ...
        static_assert(sung::are_similiar_constexpr(speed_ms.kts(), speed_kts.kts(), 0.001f), "Speed conversion failed");
        static_assert(sung::are_similiar_constexpr(speed_ms.mph(), speed_mph.mph(), 0.001f), "Speed conversion failed");
